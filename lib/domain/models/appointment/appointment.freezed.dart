...
mixin _$Appointment {
 ...
 String get id; String get name; String get service; String get date; String get time; String get status; String get price;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,service,date,time,status,price);

@override
String toString() {
  return 'Appointment(id: $id, name: $name, service: $service, date: $date, time: $time, status: $status, price: $price)';
}
...
@useResult
$Res call({
 String id, String name, String service, String date, String time, String status, String price
});
...
/// Create a copy of Appointment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? service = null,Object? date = null,Object? time = null,Object? status = null,Object? price = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String service,  String date,  String time,  String status,  String price)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Appointment() when $default != null:
return $default(_that.id,_that.name,_that.service,_that.date,_that.time,_that.status,_that.price);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String service,  String date,  String time,  String status,  String price)  $default,) {final _that = this;
switch (_that) {
case _Appointment():
return $default(_that.id,_that.name,_that.service,_that.date,_that.time,_that.status,_that.price);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String service,  String date,  String time,  String status,  String price)?  $default,) {final _that = this;
switch (_that) {
case _Appointment() when $default != null:
return $default(_that.id,_that.name,_that.service,_that.date,_that.time,_that.status,_that.price);case _:
  return null;
...
class _Appointment implements Appointment {
  const _Appointment({required this.id, required this.name, required this.service, required this.date, required this.time, required this.status, required this.price});
...
/// Create a copy of Appointment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? service = null,Object? date = null,Object? time = null,Object? status = null,Object? price = null,}) {
