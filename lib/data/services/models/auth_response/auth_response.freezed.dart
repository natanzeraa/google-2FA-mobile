...
@override
String toString() {
  return 'AuthResponse(success: $success, status: $status, user: $user, accessToken: $accessToken, refreshToken: $refreshToken, message: $message)';
}
...
class _AuthResponse implements AuthResponse {
  const _AuthResponse({required this.success, required this.status, required this.user, required this.accessToken, required this.refreshToken, required this.message});
